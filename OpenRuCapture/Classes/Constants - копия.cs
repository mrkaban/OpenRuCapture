namespace OpenRuCapture
{
    public static class Constants
    {
        ...
        public const string APP_URL = "https://КонтинентСвободы.рф";
        ...
        public const string APPINFOMESG = "{0} работает. Правый клик для настроек";
        ...
        public const string SOUNDFILTER = "Звуковые файлы (*.wav)|*.wav";
        public const string SELECTSOUND = "Выберите wav-файл";
        public const string IMAGESELECTDLGTITLE = "Выберите файл изображения";
        public const string INITMETHOD = "Инициализация";
        public const string EXECUTEMETHOD = "Выполнить";
